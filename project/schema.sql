...
CREATE TABLE IF NOT EXISTS Orders (
	...
	Phone             VARCHAR(8),
    CONSTRAINT orders_card_cash_ck CHECK (
        (Payment = 'card' AND Card IS NOT NULL AND Card <> '' AND CardType IS NOT NULL AND CardType <> '')
        OR
        (Payment = 'cash' AND (Card IS NULL OR Card = '') AND (CardType IS NULL OR CardType = ''))
    ),
    CONSTRAINT orders_card_format_ck CHECK (
...
CREATE TABLE IF NOT EXISTS OrderLines (
    ...
    LineID           INT GENERATED BY DEFAULT AS IDENTITY, 
